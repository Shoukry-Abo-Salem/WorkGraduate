...
import com.shoukry.workgraduate.databinding.FragmentUnderwayBinding;
...
public class UnderwayFragment extends Fragment {
    ...
    FragmentUnderwayBinding binding;
    RequestQueue queue;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUnderwayBinding.inflate(inflater);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        binding.recyclerViewUnderway.setAdapter(adapter);
                        binding.recyclerViewUnderway.setLayoutManager(new LinearLayoutManager(getActivity()));
                    }
